...
namespace hx
{
    ...
    {
    public:
        CodeGeneration(sptr<SymbolTable> global_table, const std::unordered_map<virtual_register, VirtualRegisterLocation>& vr_locations);
    ...
    private:
        ...
        std::unordered_map<virtual_register, VirtualRegisterLocation> vr_locations;
