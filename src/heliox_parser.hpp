...
private:	
	...
	hx_sptr<hx_expression> parse_primary();
	hx_sptr<hx_expression> parse_expression(hx_sptr<hx_expression> lhs, uint32_t depth, uint32_t precedence=0);
	hx_sptr<hx_unary_expression> parse_unary_expression();
