...
private:	
	...
	hx_sptr<hx_expression> parse_factor(hx_sptr<hx_error> error);
	hx_sptr<hx_expression> parse_term(hx_sptr<hx_error> error);
	hx_sptr<hx_expression> parse_expression(hx_sptr<hx_error> error);
